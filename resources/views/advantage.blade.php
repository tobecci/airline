  ...
  min-width: 220px;
    ...
    <body>
        ...
        <div class="banner banner-static banner-small has-bg lighter-filter bg-light has-bg-image">
            <div class="banner-cpn" style="position:absolute; width:100%; left:0; top:35%; z-index:5; transform:translateY(-50%); padding-left:400px;">
                <div class="container" style="position:static;">
                    <div class="content row" style="position=relative; margin-right:-15px; margin-left:-15px">
                        <div class="banner-text dark pos-center center" style="color:red">
                            <h1 class="page-title">
                                <a href="./" style="color:blue; outline:0; transition:all 0.5s;">Home</a>
                                > Peace Advantage 
                            </h1>
                        </div>
                    </div>
            ...
            <div class="banner-bg imagebg bg-image-loaded" style="background-image:url(advantage.jpg); background-repeat:no-repeat; margin-left:29px;;">
                <img src="advantage.jpg" alt="">
            </div>
        </div>
        <br>
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 mb-3 text-center">
                <div class="col">
                    <div class="card mb-4-shadow-sm">
                        <div class="card-header">
                           <h4 class="my-0 fw-normal">Frequent Flier Login</h4>
                        </div>
                        <form action="/advantage" method="post" id="advantageform">
                            <input type="hidden" name="" value="" />
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9 mb-3">
                                        <label for="membership_email">Membership No. or Email</label>
                                        <input type="text" class="form-control" id="membership_email" name="membership_email" placeholder="" value="" required>
                                        <div class="invalid-feedback">
                                            Valid membership no. or email is required.
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="col">
                    <div class="card mb-4-shadow-sm">
                        <div class="card-header">
                           <h4 class="my-0 fw-normal">Frequent Flier Registration</h4>
                        </div>
                        <div class="card-body">
                          <h5>New Members click the button below to register </h5>
                          <br>
                          <div class="row">
                            <div class="col-md-6 mb-3">
