  ...
  min-width: 220px;
    ...
    <body>
        ...
        <div class="banner banner-static banner-small has-bg lighter-filter bg-light has-bg-image">
            <div class="banner-cpn" style="position:absolute; width:100%; left:0; top:35%; z-index:5; transform:translateY(-50%); padding-left:450px;">
                <div class="container" style="position:static;">
                    <div class="content row" style="position=relative; margin-right:-15px; margin-left:-15px">
                        <div class="banner-text dark pos-center center" style="color:white;">
                            <h1 class="page-title">
                                <a href="./" style="color:white; outline:0; transition:all 0.5s;">Home</a>
                                > Photo Gallery 
                            </h1>
                        </div>
                    </div>
            ...
            <div class="banner-bg imagebg bg-image-loaded" style="background-image:url(gallery.jpg); background-repeat:no-repeat; margin-left:30px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image1.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image2.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image3.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image4.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image5.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image6.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image7.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image8.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image9.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div  class="col-md-6 col-sm-6">
                    <image src="image10.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image11.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div  class="col-md-6 col-sm-6">
                    <image src="image12.jpg" alt="" width="300px;" height="300px";>
                </div>
            </div>
            <br>
            <div class="row">
                <div  class="col-md-6 col-sm-6">
                    <image src="image13.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image14.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image15.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image16.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image17.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image18.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <image src="image19.jpg" alt="" width="300px;" height="300px;">
                </div>
                <div class="col-md-6 col-sm-6">
                    <image src="image20.jpg" alt="" width="300px;" height="300px;">
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-sm">
                     <image src="image21.jpg" alt="" height="400px;">
                </div>
                <div class="col-sm">
                </div>
            </div>
