  ...
  min-width: 220px;
    ...
    <body>
        ...
        <div class="banner banner-static banner-small has-bg lighter-filter bg-light has-bg-image">
            <div class="banner-cpn" style="position:absolute; width:100%; left:0; top:40%; z-index:5; transform:translateY(-50%); padding-left:500px;">
                <div class="container" style="position:static;">
                    <div class="content row" style="position=relative; margin-right:-15px; margin-left:-15px">
                        <div class="banner-text dark pos-center center" style="color:black;">
                            <h1 class="page-title">
                                <a href="./" style="color:black; outline:0; transition:all 0.5s;">Home</a>
                                > About 
                            </h1>
                        </div>
                    </div>
            ...
            <div class="banner-bg imagebg bg-image-loaded" style="background-image:url(about.jpg); background-repeat:no-repeat; margin-left:29px;;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <div class="card">
                        <div class="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="50" fill="red" class="bi bi-binoculars-fill" viewBox="0 0 16 16">
                                <path d="M4.5 1A1.5 1.5 0 0 0 3 2.5V3h4v-.5A1.5 1.5 0 0 0 5.5 1h-1zM7 4v1h2V4h4v.882a.5.5 0 0 0 .276.447l.895.447A1.5 1.5 0 0 1 15 7.118V13H9v-1.5a.5.5 0 0 1 .146-.354l.854-.853V9.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v.793l.854.853A.5.5 0 0 1 7 11.5V13H1V7.118a1.5 1.5 0 0 1 .83-1.342l.894-.447A.5.5 0 0 0 3 4.882V4h4zM1 14v.5A1.5 1.5 0 0 0 2.5 16h3A1.5 1.5 0 0 0 7 14.5V14H1zm8 0v.5a1.5 1.5 0 0 0 1.5 1.5h3a1.5 1.5 0 0 0 1.5-1.5V14H9zm4-11H9v-.5A1.5 1.5 0 0 1 10.5 1h1A1.5 1.5 0 0 1 13 2.5V3z"/>
                            </svg>
                            <h3 class="fw-light" style="text-align:center; font-family:Poppins, sans-serif;">Vision</h3>
                            <br>
                            <p class="card-text" style="text-align:center; margin-bottom:-2px;">To be ever dependable through the creation of<br> seamless 
                             connection and network options for<br> our domestic, regional<br>and<br> international markets.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm">
                    <div class="card">
                        <div class="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="50" fill="red" class="bi bi-distribute-horizontal" viewBox="0 0 16 16">
                            ...
                            <h4 class="fw-light" style="text-align:center; font-family:Poppins, sans-serif;">Mission</h4>
                            <br>
                            <p class="card-text" style="text-align:center;">To expand locations domestically and beyond as the 
                             largest and  most profitable airline<br> company to achieve safe
                             ,efficient and<br> affordable short and long haul
                             services. 
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm">
                    <div class="card">
                        <div class="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="45" fill="red" class="bi bi-grid-3x3-gap-fill" viewBox="0 0 16 16">
                            ...
                            <h4 class="fw-light" style="text-align:center; font-family:Poppins, sans-serif;">Local Content</h4>
                            <br>
                            <p class="card-text" style="text-align:center;">One of the major ideas behind setting up Air<br> Peace
                                is to create massive employment<br> opportunities for Nigerians, thereby
                                contributing<br> to the well-being of our people.
                            </p>
                        </div>
                    </div>
                </div>
