            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div>
                    ...
                    @csrf
                        ...
                        <div class="">
                            <div class="">
                                <button type="button" class="btn btn-md btn-block btn-info">Return</button>
                            </div>
                            <br>
                            <div class="">
                                <button type="button" class="btn btn-md btn-block btn-primary">One Way</button>
                            </div>
                        </div>
                        <br>
                        <div>
                ...
                <div>
                    ...
                    <p><strong>Arrival Time: </strong>{{$userInput['arrival']}}</p>
                    @elseif($userInput['arrival'] =='')

                    @endif
                    <p><strong>Fare Type: </strong>Economy Flexi Domestic</p>
                    <p><strong>Net Fare: </strong> 37,000.00 NGN</p>
                    <p><strong>Inc Tax: </strong>23,000.00 NGN</p>
                    <p><strong>Total Fare: </strong>60,000.00 NGN</p>
                    <hr>
                    <h4>Summary:</h4>
                    <p><strong>Flights Total: </strong>140,000.00 NGN</p>
            ...
            <div role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div id="tabs">
                    ...
                    <div id="tabs-3">
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal">Adult 1 (Lead Passenger)</h4>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="custom-select d-block w-100" id="title" required="" name="title">
                                        ...
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lastName" placeholder="gughug" name="last_name" value="" required="">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="custom-select d-block w-100" id="gender" name="gender" required="Male">
                                                <option>Male</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="passenger1countryofresidence" name="passenger1countryofresidence" class=" form-control  required  PassengerDetailsInput_country PassengerDetailsInput_countryofresidence">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="cc-cvv" name="email_address" placeholder="johndoe@gmail.com" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="email" name="verify_email" placeholder="johndoe@gmail.com" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div>
                                        <hr class="mb-4">
                                        <h4>Existing Peace Advantage Member</h4>
                                        <div class="mb-3">
                                            <label for="number_or_email">Peace Advantage number or email address</label>
                                            <input type="text" class="form-control" name="existing_peace_advantage_member" id="address2" placeholder="">
                                            <div class="invalid-feedback">
                                                Please enter your Peace Advantage number or address.
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <button type="button" name="login" class=" return_btn btn btn-md btn-block btn-info">Login</button>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" name="forgot_password" class=" one_btn btn btn-md btn-block btn-primary">I forgot my Password</button>
                                            </div>
                                        </div>
                                        <hr class="mb-4">
                                    </div>
                                    <div>
                                        <hr class="mb-4">
                                        <h4>New Peace Advantage Member</h4>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="new_peace_advantage_member" class="custom-control-input" id="same-address">
                                            <label class="custom-control-label" for="same-address">I would like to create a Customer Profile</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="terms_and_condition" id="terms_and_condition">
                                            <label class="custom-control-label" for="terms_and_condition">I accept Peace Advantage <i>terms and conditions</i></label>
                                        </div>
                                        <hr class="mb-4">
                                    </div>
                                    <div>
                                        ...
                                        <h6>Please tell us if you have any Special Requirements:</h6>
                                        <div class="d-block my-3">
                                            <div class="custom-control custom-radio">
                                                <input id="credit" name="specialRequirements" type="radio" class="custom-control-input" checked required>
                                                <label class="custom-control-label" for="credit">I have no Special Requirements</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input id="debit" name="specialRequirements" type="radio" class="custom-control-input" required>
                                                <label class="custom-control-label" for="debit">Please select from list</label>
                                            </div>
                                            <br>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="save-info">
                                                <label class="custom-control-label" for="save-info">Remember these details for my next week</label>
                                            </div>
                                        </div>
                                        <hr class="mb-4">
                                    </div>
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal">Adult 2</h4>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate>
                                    <h4>Mandatory Information</h4>
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal">Child 1</h4>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate>
                                    <h4>Mandatory Information</h4>
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal">Infant 1</h4>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" novalidate>
                                    <h4>Mandatory Information</h4>
                    ...
                    <div id="tabs-4">
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="card-header">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <p>Jan 31,2021 - Feb 15,2021.</p>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <p style="text-align:right;">1 Round Trip Ticket</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-7 mb-3" style="background-color:lightgray; padding-top:20px;">
                                                <h4>Jan 31,2021 - Departure Non-Stop</h4>
                                            </div>
                                            <div class="col-md-5 mb-3" style="background-color:lightgray; padding-top:20px;">
                                                <h4>Travel Time:1hr 30min</h4>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <h6>Lagos(LOS) - Abuja(ABJ)</h6>
                                                <h6>7:00am - 8:30am</h6>
                                                <h6>Flight Number:P47004</h6>
                                                <h6>Fare Type:Economy Flexi Domestic</h6>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-7 mb-3" style="background-color:lightgray; padding-top:20px;">
                                                <h4>Feb 15,2021 - Departure Non-Stop</h4>
                                            </div>
                                            <div class="col-md-5 mb-3" style="background-color:lightgray; padding-top:20px;">
                                                <h4>Travel Time:1hr 30min</h4>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3" style="padding-top:10px;">
                                                <h6>Abuja(ABJ) - Lagos(LOS)</h6>
                                                <h6>5:30pm - 7:00pm</h6>
                                                <h6>Flight Number:P47126</h6>
                                                <h6>Fare Type:Economy Flexi Dosmestic</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header">
                                        <h4 class="my-0 font-weight-normal">Price Summary</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <h6>Traveller 1</h6>
                                                    <h6>Net Fare:89000.00 NGN</h6>
                                                    <h6>Inc Tax:23000.00 NGN</h6>
                                                    <hr>
                                                    <h6>=112,000.00 NGN</h6>
                                                    <hr>
                                                </div>
                                                <hr>
                                                <div class="col-md-11">
                                                    <h6>Traveller 2</h6>
                                                    <h6>Net Fare:88000.00 NGN</h6>
                                                    <h6>Inc Tax:23000.00 NGN</h6>
                                                    <hr>
                                                    <h6>111,000.00 NGN</h6>
                                                    <hr>
                                                </div>
                                                <hr>
                                                <div class="col-md-11">
                                                    <h6>Child 1</h6>
                                                    <h6>Net Fare:87000.00 NGN</h6>
                                                    <h6>Inc Tax:23000.00 NGN</h6>
                                                    <hr>
                                                    <h6>=110,000.00 NGN</h6>
                                                    <hr>
                                                </div>
                                                <hr>
                                                <div class="col-md-11">
