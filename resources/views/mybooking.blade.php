            ...
            <div class="row" style="background-repeat:no-repeat; background-size:100% auto; background-image:url(/background.jpg); min-height:600px;>
              ...
              <div class="col-lg-offset-1 col-md-offset-1 col-lg-6 col-md-5 col-xs-offset-0 col-sm-offset-0 col-sm-6 col-x2-12>
                <div class="panel-group">
                  <div class="card md-4 shadow-sm" style="margin-top:30%;">
                    <div class="card-header">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-in-down-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M9.636 2.5a.5.5 0 0 0-.5-.5H2.5A1.5 1.5 0 0 0 1 3.5v10A1.5 1.5 0 0 0 2.5 15h10a1.5 1.5 0 0 0 1.5-1.5V6.864a.5.5 0 0 0-1 0V13.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
                        <path fill-rule="evenodd" d="M5 10.5a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 0-1H6.707l8.147-8.146a.5.5 0 0 0-.708-.708L6 9.293V5.5a.5.5 0 0 0-1 0v5z"/>
                    </svg>
                      <h4 class="my-0 font-weight-normal">Manage My Booking</h4>
                    </div>
                    <form action="/mybooking" method="post" id="mybookingform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">    
                                <div class="col">
                                    <input type="text" class="form-control" id="bookingreference" name="booking_reference" placeholder="Booking Reference:" value="" required>
                                    <div class="invalid-feedback">
                                    Valid Booking Reference Number is required.
                                    </div>
                                </div>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-md btn-block btn-info">Ok</button>
                        </div>
                    </form>
                  </div>
                </div>
